...
if __name__ == "__main__":
    ...
    model_paths = [
        "results/fine_tuned_roberta_large_tweeteval_sentiment",
        "results/distilled_model_tweeteval/distilled_distilroberta_tweeteval",
        "results/distilled_model_tweeteval/distilled_distilbert_tweeteval",
        "results/distilled_model_tweeteval/distilled_minilm_tweeteval",
        "results/distilled_model_tweeteval/distilled_tinybert_tweeteval"
    ]
    ...
    csv_file = "results/benchmarks/inference_results_tweeteval.csv"
